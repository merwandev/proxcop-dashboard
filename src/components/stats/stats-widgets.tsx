  ...
  const renderWidget = (id: string): ReactNode => {
    switch (id) {
      case "category-funnel":
        if (roiByCategory.length === 0) return null;
        return (
      ...
      case "stock-evolution":
        if (stockEvolution.length < 2) return null;
        return (
          <Card className="p-4 bg-card border-border">
            <div className="flex items-start justify-between mb-3">
              <div>
      ...
      case "platform-roi":
        if (roiByPlatform.length === 0) return null;
        return (
          <Card className="p-4 bg-card border-border">
            <div className="flex items-start justify-between mb-3">
              <div>
      ...
      case "margin-distribution":
        if (marginDistribution.length === 0) return null;
        return (
          <Card className="p-4 bg-card border-border">
